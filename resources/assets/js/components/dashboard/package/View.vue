          ...
          <div class="row">
            <div class="col-sm-12 text-right">
              ...
              <ul class="nav nav-tabs menuTab" id="myTab" role="tablist">
                <li class="nav-item">
                  <a class="nav-link active" @click.prevent="fetchData('All')" href="#" role="tab">All Customers</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" @click.prevent="createModal" href="#"><span class="icon icon-user"></span> Active Customers</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" @click.prevent="createModal" href="#"><span class="icon icon-user"></span> Suspended Customers</a>
                </li>
              </ul>
            </div>
            <div class="col-lg-12">
...
<script>
    export default {
        ...
        methods: {
          load(){
            axios.get('/api/package/customer/' + this.$route.params.id).then(( data ) => { this.packages = data.data } );
          },
          createModal(){
            this.editmode = false;
            this.form.reset();

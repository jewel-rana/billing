          ...
          <div class="row">
            <div class="col-sm-12 text-right">
              ...
              <ul class="nav nav-tabs menuTab" id="myTab" role="tablist">
                <li class="nav-item">
                  <router-link class="nav-link tabbed-menu" to="/dashboard/manage/users" role="tab">User</router-link>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                  <router-link class="nav-link tabbed-menu active" to="/dashboard/manage/permissions">Permissions</router-link>
                </li>
              </ul>
            </div>
            <div class="col-lg-12">

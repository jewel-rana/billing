          ...
          <div class="row">
            <div class="col-sm-12 text-right">
              ...
              <ul class="nav nav-tabs menuTab" id="myTab" role="tablist">
                <li class="nav-item">
                  <router-link class="nav-link tabbed-menu" to="/dashboard/report" role="tab"><i class="fa fa-calendar"></i> Daily</router-link>
                </li>
                <li class="nav-item">
                  <router-link class="nav-link tabbed-menu active" to="/dashboard/report/monthly"><i class="fa fa-chart-bar"></i> Monthly</router-link>
                </li>
                <li class="nav-item">
                  <router-link class="nav-link tabbed-menu" to="/dashboard/report/anual"><i class="fa fa-chart-pie"></i> Anual</router-link>
                </li>
              </ul>
            </div>
            <div class="col-lg-12">

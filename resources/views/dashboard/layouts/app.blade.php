...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/lib/bootstrap-slider/css/bootstrap-slider.min.css') }}"/>
    ...
    <div class="be-wrapper" id="app">
      <nav class="navbar navbar-expand fixed-top be-top-header">
        <div class="container-fluid">
          <div class="be-navbar-header"><router-link class="navbar-brand" to="/dashboard"></router-link>
          </div>
            ...
            <div class="left-sidebar-scroll">
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li><router-link to="/dashboard"><i class="icon mdi mdi-home"></i><span>Dashboard</span></router-link>
                  </li>
                  <li class="parent"><a href="#"><i class="icon mdi mdi-dot-circle"></i><span>Components</span></a>
                    <ul class="sub-menu">
                      <li><router-link to="/dashboard/post">Posts</router-link>
                      </li>
                      <li><router-link to="/dashboard/category">Categories</router-link>
                      </li>
                      <li><router-link to="/dashboard/location"><i class="icon mdi mdi-pin"></i> <!-- <span class="badge badge-primary float-right">New</span> -->Locations</router-link>
                    </ul>
                  </li>
                  <li class="parent"><a href="#"><i class="icon mdi mdi-dot-circle"></i><span>Pages</span></a>
                    <ul class="sub-menu">
                      <li><router-link to="/dashboard/page/create">Add new page</router-link>
                      </li>
                      <li>
                        <router-link to="/dashboard/page">Pages</router-link>
                      </li>
                    </ul>
                  </li>
                  <li>
                    <router-link to="/dashboard/menu"><i class="icon mdi mdi-dot-circle"></i><span>Menus</span></router-link>
                  </li>
                  <li class="parent"><a href="#"><i class="icon mdi mdi-dot-circle"></i><span>Management</span></a>
                    <ul class="sub-menu">
                      <li><router-link to="/dashboard/user">Users</router-link>
                      </li>
                      <li>
                        <router-link to="/dashboard/role">Roles</router-link>
                      </li>
                    </ul>
                  </li>
                </ul>
        ...
        <!-- <div class="page-head">
          ...
          <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb page-head-nav">
              ...
              <li class="breadcrumb-item">
                <router-link to="/dashboard/menu">{{ ucfirst( Request::segment(2) ) }}</router-link>
              </li>
            </ol>
          </nav>
        </div> -->
